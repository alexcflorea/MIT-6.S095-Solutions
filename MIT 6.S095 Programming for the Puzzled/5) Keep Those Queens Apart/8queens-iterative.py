                            ...
                            for p in range(n):
                                ...
                                for q in range(n):
                                    ...
                                    if noConflicts(board, 7):
                                        for r in queenLocations:
                                            if board[r] != location[r]:
                                                break
                                            print (board)
                                            sol -= 1
                                            if sol == 0:
...
#implementation of location is still buggy, but it works okay for what we need
EightQueens(20, [5, -1, -1, -1, 7, -1, -1, -1])

...
def howHardIsTheCrystal(n, d):
    ...
    #Check for unused balls
    unused = 0            
    while r**(d-1) > n:
        d -= 1
        unused += 1
    if unused > 0:
        print(unused, 'balls unnecessary, only dropping', d, 'balls')
    ...
    for i in range(d):
        #Begin phase i
        for j in range(r-1):
            print('Range of floors:', minMaxFloor)
